...
export const metadata: Metadata = {
  ...
  description: "Discover the finest luxury vehicles at Prestige Motors. Mercedes-Benz, BMW, Porsche, and more premium brands with expert service and concierge support.",
  keywords: "luxury cars, premium vehicles, Mercedes-Benz, BMW, Porsche, car dealership, luxury automotive",
  openGraph: {
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Experience automotive excellence with our curated collection of luxury vehicles from the world's most prestigious manufacturers.",
    siteName: "Prestige Motors",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763468334849-2g7954qw.jpg",
        alt: "Premium luxury car at Prestige Motors"
      }
    ]
  },
  twitter: {
    ...
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Experience automotive excellence with our curated collection of luxury vehicles.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763468334849-2g7954qw.jpg"]
  },
  robots: {
    index: true,
    follow: true
